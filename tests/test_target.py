...
class Test_Target( unittest.TestCase ):
    ...
    def test_db_target_complex( self ):
        ...
        self.assertEqual(
            ...
            [
                {'SERIAL_NUMBER': 1, 'LIST': ['1st', '2nd', '3rd'], 'VALUE': [1, 2, 3, 4, 5, [6, 7]]},
                {'SERIAL_NUMBER': 2, 'LIST': ['3rd', '2nd', '1st'], 'VALUE': {'second': 2, 'third': [1, 2, 3], 'first': 1}}
            ]
        )
    ...
    def test_db_target_limit( self ):
        ...
        self.assertEqual( 255, target.database.table.c.name.type.length )
        self.assertEqual( 130, target.database.table.c.name_limited.type.length )
