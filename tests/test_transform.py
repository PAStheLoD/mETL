...
class Test_Transform( unittest.TestCase ):
    ...
    def test_stem_transform( self ):
        ...
        self.field.setValue('contains hungarian members attractive sadness killing')
    ...
    def test_replace_by_regexp( self ):
        ...
        self.field.setValue('2012-04-20')
