...
class Test_FieldType( unittest.TestCase ):
    ...
    def test_datetime_field_type( self ):
        ...
        self.assertEqual( ft.getValue('2013-04-04 16:06:58.929515'), datetime.datetime( 2013, 4, 4, 16, 0o6, 58, 929515 ) )
        self.assertIsNone( ft.getValue( None ) )
    ...
    def test_field_type_convert_to_datetime( self ):
        ...
        self.assertEqual( fs.getValue( DateTimeFieldType().getValue( datetime.datetime( 2013, 4, 4, 16, 0o6, 58, 929515 ) ) ), datetime.datetime( 2013, 4, 4, 16, 0o6, 58, 929515 ) )
        self.assertEqual( fs.getValue( StringFieldType().getValue('2013-04-04 16:06:58.929515') ), datetime.datetime( 2013, 4, 4, 16, 0o6, 58, 929515 ) )
        self.assertEqual( fs.getValue( TextFieldType().getValue('2013-04-04 16:06:58.929515') ), datetime.datetime( 2013, 4, 4, 16, 0o6, 58, 929515 ) )
        self.assertIsNone( fs.getValue( None ) )
    ...
    def test_field_type_convert_to_string( self ):
        ...
        self.assertEqual( fs.getValue( DateTimeFieldType().getValue( datetime.datetime( 2013, 4, 4, 16, 0o6, 58, 929515 ) ) ), '2013-04-04 16:06:58.929515' )
        self.assertEqual( fs.getValue( FloatFieldType().getValue( 4.232 ) ), '4.232' )
        self.assertEqual( fs.getValue( IntegerFieldType().getValue( 5 ) ), '5' )
