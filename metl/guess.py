...
class Guess( object ):
    ...
    def guess( self ):
        ...
        if self.fields is not None:
            self.fields = [ v for k, v in list(self.fields.items()) ]
    ...
    def determineFields( self ):
        ...
        for record in self.records:
            current = {}
            for name, field in list(record.getFields().items()): 
                current[ name ] = {
                    'name': field.getName(),
    ...
    def determineFieldTypes( self ):
        ...
        for field_name, cfg in list(self.fields.items()):
    ...
    def getConfig( self ):
        ...
        for k, v in list(self.base.get('source',{}).items()):
            if k in list(source.keys()) and source[k] == v:
                del source[k]
        ...
        if 'target' in self.base and len( list(self.base['target'].keys()) ):
            del d_ret['target']
