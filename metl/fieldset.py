...
class FieldSet( object ):
    ...
    def transform( self ):
        ...
        for field in list(self.getFields().values()):
            field.run()

    # bool
    def hasField( self, field_name ):

        return field_name in list(self.fields.keys())
    ...
    def setValues( self, values, base = None ):
        ...
        for field_name, value in list(self.getFieldMap().getValues( values, base ).items()):
            try:
    ...
    def getValues( self, without_none = False, to_string = False, class_to_string = False, without_list = False ):
        ...
        ret_dict = {}
        for field_name, field in list(self.getFields().items()):
    ...
    def getFieldMap( self ):
        ...
        self.fieldmap = metl.fieldmap.FieldMap( dict( list(zip( self.getFieldNames(), self.getFieldNames() )) ) )
        return self.fieldmap
    ...
    def getHash( self ):
        ...
        return hash( frozenset( list(self.getValues( without_none = True, without_list = True ).values()) ) )
    ...
    def addField( self, field_obj, skip_check_exists = False ):
        ...
        if not skip_check_exists and field_obj.getName() in list(self.fields.keys()):
    ...
    def getKeyForFields( self, keys ):
        ...
        return '-'.join([ values[field_name] for field_name in keys ])
